...
```
#tells you where the NA's are in each column
...
#dont want to do this by default because you don't know how it is represented yet
```
...
```
#very helpful because it is adaptable and makes replacement of NAs specific 
