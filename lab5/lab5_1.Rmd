...
```{r}
mammals_new <- select(mammals, "mass","gestation","newborn","genus")
filtered_new <- filter(mammals_new, genus == "Lophobecus" | genus == "Erythrocebus" | genus == "Macaca")
```

```{r}
min(filtered_new, "newborn")
```
